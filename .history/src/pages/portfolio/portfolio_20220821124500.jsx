    ...
    <div className="portfolio">
      <div className="left">
        ...
        <h3>
          ...
          <br />
          User can register an account for the blog. After logging in, user can
          write their own articles in this blog app.
          <br />
        </h3>
      </div>
      <div className="right">
        ...
        <h3>
          ...
          <br />
          They can pay the bill by Paypal or cash in delivery.
          <br />
